  ...
  <div class="flex flex-col">
    ...
    <div class="flex flex-wrap flex-row justify-center p-6 gap-5">
      <div class="flex justify-around flex-col w-full max-w-lg bg-gray-800 drop-shadow-[0px_0_3px_#9ca3af] rounded-3xl p-5 border-2 border-gray-400 text-white font-medium gap-1">
        <div class="text-2xl text-center mb-4 text-violet-500">BUY PRE-FUEL WITH <span class="text-yellow-300">BUSD</span></div>
        ...
        <div class="text-sm sm:text-base flex items-center justify-between">
          ...
          <div>{{this.formatNumber(this.getBalanceNumber(preFuelBalance, preFuelDecimals))}}</div>
        </div>
        <div class="text-sm sm:text-base flex items-center justify-between">
          <div>Your BUSD balance:</div>
          <div>{{this.formatNumber(this.getBalanceNumber(busdBalance, busdDecimals))}}</div>
        </div>
        <div class="text-sm sm:text-base flex items-center justify-between">
      ...
      <div class="flex justify-around flex-col w-full max-w-lg bg-gray-800 drop-shadow-[0px_0_3px_#9ca3af] rounded-3xl p-5 border-2 border-gray-400 text-white font-medium gap-1">
        ...
        <div class="text-sm sm:text-base flex items-center justify-between">
          ...
          <div>{{this.formatNumber(this.getBalanceNumber(fuelBalance, fuelDecimals))}}</div>
        </div>
        <div class="text-sm sm:text-base flex items-center justify-between">
