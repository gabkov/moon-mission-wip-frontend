<template>
  <li>
    <router-link active-class="bg-sky-800 border-sky-400" :to="to" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-sky-800 text-white-600 hover:text-white-800 ml-1 border-2 rounded-md hover:border-sky-400 border-transparent pr-6">
