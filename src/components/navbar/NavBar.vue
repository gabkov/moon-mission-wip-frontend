<template>
  <div class="opacity-[0.98] fixed w-full flex items-center justify-between h-14 bg-gradient-to-b from-gray-900 to-gray-800 text-white shadow-lg shadow-sky-500 border-b-[3px] border-gray-600 z-[1]">
